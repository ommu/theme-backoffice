...
<div class="submenu">
	...
	<?php } elseif($module != null && !in_array($module, array('users','report','support'))) {
		...
		<?php if(Yii::app()->user->level == 1) {?>
			...
			<li <?php echo $currentAction == 'settings/locale' || in_array($controller, array('locale','zonecountry','zoneprovince','zonecity','zonedistrict','zonevillage')) ? 'class="submenu-show"' : '' ?>>
